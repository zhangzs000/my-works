...
module.exports = {
  build: {
    ...
    assetsSubDirectory: ('static'),
    // 线上地址跟本地开发地址是有差异化的, 因为front.aixuexi.com/zootropolis/ 通过ngx代理过滤到 zootroplis.aixuexi.com/ 静态文件目录需要增加 zootropolis
    assetsPublicPath: SRC_CONFIG.BUILD && SRC_CONFIG.BUILD.assetsPublicPath || '/',
