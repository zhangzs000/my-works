...
<template>
  <div>
    <el-upload
      ...
      <div v-if="uploadProps.className==='upload-demo'" style="text-align: left;">
  ...
  methods: {
    ...
    _initUpload() {
      const {
        model:
          {
            ext: { label, params, params: { businessKey, token_oss }, listType, multiple, layout, tips, uploadBtnStyle, accept, limit, className }
          }
      } = this.uploadProps
